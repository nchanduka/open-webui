...
class Pipeline:
    ...
    class Valves(BaseModel):
        MLIS_ENDPOINT: str = Field(
            ...
            description="MLIS OpenAI API compatible endpoints.",
        )
        MODEL_ID: str = Field(
        ...
        SYSTEM_PROMPT: str = Field(
            default="You are a highly skilled AI model tasked with generating high-quality code based on user inputs.",
    ...
    def pipe(
        ...
        # Remove user from payload, as it is a dictionary, not supported by /chat/completions request 
        #payload.pop("user")
...
1. Code Standards:
   ...
   - Use single quotes only consistently throughout the code.
...
7. Write Test Cases:
   - Include test cases for the code.
